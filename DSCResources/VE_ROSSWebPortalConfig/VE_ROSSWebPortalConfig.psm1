...
#>
    [CmdletBinding()]
    param (
        ## RES ONE Identity Director Web Portal configuration file path
        [Parameter(Mandatory)]
        [System.String] $Path,
        ...
        ## RES ONE Identity Director Web Portal Application/Callback Uri
        [Parameter()]
        [ValidateNotNullOrEmpty()]
...
function Get-TargetResource {
    ...
    $targetResource = @{
        ...
        ApplicationUrl = $webConfig.webConsoleConfiguration.authentication.identityBroker.redirectUrl;
        ClientId = $webConfig.webConsoleConfiguration.authentication.identityBroker.clientId;
...
function Set-TargetResource {
    ...
    if ($Ensure -eq 'Present') {
        ...
        Save-ROSSWebPortalConfiguration @PSBoundParameters;
    }
    else {
